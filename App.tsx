...
export default function App() {
  ...
  const Icon = (props: IconProps) => {
    ...
    return (
      <Svg viewBox={props.viewBox} style={styles.icon}>
        <Path fill={props.focused ? colors.blue : colors.white} d={path} />
      </Svg>
    );
  };
      ...
      <Tab.Navigator>
        <Tab.Screen
          ...
          options={{
            ...
            tabBarIcon: ({ focused }) => (
              <Icon d="explore" focused={focused} viewBox="0 0 576 512" />
            ),
          }}
        />
        <Tab.Screen
          ...
          options={{
            ...
            tabBarStyle: styles.tabBar,
            tabBarIcon: ({ focused }) => (
              <Icon d="search" focused={focused} viewBox="0 0 512 512" />
            ),
          }}
        />
        <Tab.Screen
          ...
          options={{
            ...
            tabBarStyle: styles.tabBar,
            tabBarIcon: ({ focused }) => (
              <Icon d={"favourites"} focused={focused} viewBox="0 0 512 512" />
            ),
          }}
        />
      </Tab.Navigator>
